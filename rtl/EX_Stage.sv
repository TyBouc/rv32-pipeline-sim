...
module EX_Stage (
    ...
    case (fa_mux_ip) 
      ...
      */
      EX_RESULT_SELECT: begin
        alu_operand_a = alu_result_op; // ALU forwarding
      end
      WB_RESULT_SELECT: begin
        alu_operand_a = fw_wb_data; //forward from WB stage
      end
  ...
  always @(*) begin
    case (fb_mux_ip) 
      ...
      */
      EX_RESULT_SELECT: begin
        alu_operand_b = alu_result_op; //forward from EX stage
      end
      WB_RESULT_SELECT: begin
        alu_operand_b = fw_wb_data; //forward from WB stage
      end
